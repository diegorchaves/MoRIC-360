...
def get_args():
    ...
    parser.add_argument('--hidden_features', type=int, default=64, help='hidden features')
    parser.add_argument('--hidden_layer', type=int, default=2, help='number of layers')
    parser.add_argument('--sythesis_features', type=int, default=12, help='synthesis features')
    ...
    parser.add_argument('--mask_type', type=str, default='full', 
                       choices=['full', 'lossy', 'lossless'],
                       help='Type of mask to use: full (all ones), lossy (lossy regions), lossless (lossless regions)')

...
def create_mask(height, width, mask_type="full", mask_path=None):
    ...
    if mask_type == "full":
        ...
        target_mask[:, :, top:bottom, :] = True  # equador = True
        return target_mask
...
def get_save_path(args, image_index):
    ...
    folder_path = (
        f"./saved/modbase_{args.mod_base}/context_{args.context_arm}"
    ...
    saved_path = (
        f"{folder_path_}/inr_mod_{args.dim_arm_mod}KODAK_ROI_Global_new_struture_7_"

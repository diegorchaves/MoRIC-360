...
class Trainer:
    ...
    def train_stage_1(self, target_mask, dataloader, total_steps=100000, steps_til_summary=10):
        """
        ...
        # Prepare coordinates
        coords = get_mgrid(width // self.args.scale, height // self.args.scale, 2).to(self.device)
        ...
        for step in range(total_steps + 1):
            ...
            self.model.soft_round_temperature = initial_temperature - (step / total_steps) * (
            ...
            if not step % steps_til_summary or (step == total_steps - 1):
                ...
                if (loss < best_rd) and (step > 0):
                    ...
                    print(f"Step {step}, BEST PSNR: {psnr_this_iter:.6f}, Total loss {loss:.6f} "
            ...
            nn.utils.clip_grad_norm_(
                ...
                10, norm_type=2.0, error_if_nonfinite=False
            )
            optim.step()
            scheduler.step()
    ...
    def train_stage_2(self, target_mask, dataloader, checkpoint, total_steps=10000, steps_til_summary=10):
        """
        ...
        for step in range(total_steps):
            ...
            if not step % steps_til_summary or (step == total_steps - 1):
                ...
                if (loss_2 < best_rd_2) and (step > 0):
                    ...
                    print(f"Step {step}, BEST PSNR: {psnr_this_iter:.6f}, Total loss {loss_2:.6f}")
            ...
            if current_lr < 1e-8:
                ...
                print("Stopping training early: Learning rate has dropped below threshold")
                break
    ...
    def evaluate(self, target_mask, dataloader, coords=None):
        ...
        return psnr_eval, bits_rate_eval.item(), bits_rate_eval_num.item(), loss_mse.item()
